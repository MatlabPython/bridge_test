...
/**
 * 执行该程序会对指定设备进行数据分析 数据来源来自HIVE 数据检测结果会保存C:\bridge_equipment
 * @author xj
 *
 */
...
public class HiveDataAnalysisJunit {
	...
	{
		ArrayList<databiud> devjunit = HbaseDataAnalysis.devHivejunit("繁华大道跨南淝河大桥", "17", "5", "20180329", "2018-03-29 01:00:00");
